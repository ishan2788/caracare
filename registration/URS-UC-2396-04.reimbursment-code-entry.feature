...
Feature: UC-37 - New User Registration
  ...
  Scenario: New users should be able to enter a reimbursement code.
	...
	And user  should remain on the same screen
	And user should see "Leider ist ein technisches Problem aufgetreten und wir können aktuell keine Verbindung zu deiner Krankenkasse aufbauen. Bitte versuche es später erneut."
